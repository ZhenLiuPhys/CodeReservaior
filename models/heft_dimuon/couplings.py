...
from object_library import all_couplings, Coupling, cmath
...
GC_1 = Coupling(name = 'GC_1',
                value = '-(AH*complex(0,1)*(cmath.cos(ytau)+complex(0,1)*cmath.sin(ytau)))',
                order = {'HIW':1})
...
GC_9086 = Coupling(name = 'GC_9086',
                 value = '-((complex(0,1)*ymu)/cmath.sqrt(2))',
                 order = {'QED':1})
                 
GC_9186 = Coupling(name = 'GC_9186',
