...
V_18 = Vertex(name = 'V_18',
              particles = [ P.G0, P.G0, P.ns, P.ns, P.ns, P.ns ],
              color = [ '1' ],
              lorentz = [ L.SSSSSS1 ],
              couplings = {(0,0):C.GC_63})

V_19 = Vertex(name = 'V_19',
              particles = [ P.G__minus__, P.G__plus__, P.ns, P.ns, P.ns, P.ns ],
              color = [ '1' ],
              lorentz = [ L.SSSSSS1 ],
              couplings = {(0,0):C.GC_63})

V_20 = Vertex(name = 'V_20',
              particles = [ P.H, P.H, P.ns, P.ns, P.ns, P.ns ],
              color = [ '1' ],
              lorentz = [ L.SSSSSS1 ],
              couplings = {(0,0):C.GC_63})

V_21 = Vertex(name = 'V_21',
              particles = [ P.H, P.ns, P.ns, P.ns, P.ns ],
              color = [ '1' ],
              lorentz = [ L.SSSSS1 ],
              couplings = {(0,0):C.GC_64})

V_22 = Vertex(name = 'V_22',
              particles = [ P.ns, P.ns, P.ns, P.ns ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
