...
Wp__plus__ = Particle(pdg_code = 9916663,
                      name = 'Wp+',
                      antiname = 'Wp-',
                      spin = 3,
                      color = 1,
...
Hzero = Particle(pdg_code = 9936660,
                 name = 'Hzero',
                 antiname = 'Hzero',
                 spin = 1,
                 color = 1,
...
Azero = Particle(pdg_code = 9946660,
                 name = 'Azero',
                 antiname = 'Azero',
                 spin = 1,
                 color = 1,
...
H__plus__ = Particle(pdg_code = 9956660,
                     name = 'H+',
                     antiname = 'H-',
                     spin = 1,
                     color = 1,
