...
#only save the CP-odd interaction used proxy cHB
V_9103 = Vertex(name = 'V_9103',
               particles = [ P.V, P.V, P.H ],
               color = [ '1' ],
               lorentz = [ L.VVS5 ],
               couplings = {(0,0):C.GC_1760})

#leading dim4 interaction used proxy cH
V_9104 = Vertex(name = 'V_9104',
               particles = [ P.V, P.V, P.H ],
               color = [ '1' ],
               lorentz = [ L.VVS7 ],
               couplings = {(0,0):C.GC_91810})
...
V_9672 = Vertex(name = 'V_9672',
               particles = [ P.mu__plus__, P.mu__minus__, P.V ],
               color = [ '1' ],
               lorentz = [ L.FFV6 ],
               couplings = {(0,0):C.GC_1707})

V_9670 = Vertex(name = 'V_9670',
               particles = [ P.e__plus__, P.e__minus__, P.V ],
               color = [ '1' ],
               lorentz = [ L.FFV6 ],
               couplings = {(0,0):C.GC_1707})
