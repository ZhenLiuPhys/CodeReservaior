...
c
 ...
 25   format( 1x,a16,2x,f7.3,' GeV        ',a16,2x,f7.4,' GeV')
      ...
      write(6,20) 'G2C  =  ', G2C
      write(6,20) 'GC  =  ', GC
      write(6,11) 'GT1N1M(L)  =  ', GT1N1M(1),'GT1N1M(R)  =  ', GT1N1M(2)
      write(6,11) 'GT1N1P(L)  =  ', GT1N1P(1),'GT1N1P(R)  =  ', GT1N1P(2)
      write(6,20) 'GAULUL  =  ', GAULUL
      write(6,20) 'GGAULUL  =  ', GGAULUL
      write(6,*)
      ...
      write(6,*) '-----------------------------'
      write(6,*)
      write(6,24) 'TRMASS  =  ', TRMASS, 'TRWIDTH    = ', TRWIDTH
