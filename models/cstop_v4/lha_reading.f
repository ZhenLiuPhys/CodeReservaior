...
c     &        ivalue(n),value(n),name(n)
 ...
 99    continue      
       ...
       call set_it(n,ivalue,value,name,1000006,bn,trmass,100d0)
       call set_it(n,ivalue,value,name,1000022,bn,chmass,100d0)
       bn="decay"
       ...
       call set_it(n,ivalue,value,name,1000006,bn,trwidth,1d0)
       call set_it(n,ivalue,value,name,1000022,bn,chwidth,1d0)
       bn='mguser'
       call set_it(n,ivalue,value,name,1,bn,y ,0d0)
      return
      end
