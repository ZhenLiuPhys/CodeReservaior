...
// Wed Aug 12 10:44:31 2015 by ROOT version 5.34/28
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   const Int_t kMaxParticle = 1001;
   const Int_t kMaxTrack = 134;
   const Int_t kMaxTower = 390;
   const Int_t kMaxEFlowTrack = 134;
   const Int_t kMaxEFlowPhoton = 219;
   const Int_t kMaxEFlowNeutralHadron = 170;
...
class higgsino : public TSelector {
public :
   ...
   higgsino(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~higgsino() { }
