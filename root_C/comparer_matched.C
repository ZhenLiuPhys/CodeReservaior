...
void comparer_matched(){

  newstyle(0);
  
  //  TFile *fb = new TFile("higgsinos_ttbar.root");
  TFile *fb = new TFile("higgsinos_ttbar_newest.root");
  TFile *fs = new TFile("higgsinos_topsmatched.root");
  //  TFile *fs = new TFile("higgsinos_ttbar_1jmatched_13TeV.root");
  //TFile *fs = new TFile("higgsinos_ttbar_matched.root");
  ...
  char* standcuts = "";
  //char* standcuts = "MET > 150 && MT20 > 70";
  // char* standcuts = "MT22 > 80 && MET > 80.";
  //char* standcuts = "MT22 > 120.";
  //  char* standcuts = "MT22 > 120";
  ...
  TH1F *b_mtlep = new TH1F("b_mtlep", ";mTl (GeV);area norm", 20, 0, 200);
  TH1F *b_mttau = new TH1F("b_mttau", ";mTtau (GeV);area norm", 20, 0, 200);
  TH1F *b_mtall = new TH1F("b_mtall", ";mTall (GeV);area norm", 25, 0, 1000);
  TH1F *b_mltau = new TH1F("b_mltau", ";mltau (GeV);area norm", 30, 0, 300);
  TH1F *b_mt20 = new TH1F("b_mt20", ";mT20 (GeV);area norm", 20, 0, 200);
  ...
  TH1F *s_mtlep = new TH1F("s_mtlep", ";mTl (GeV);area norm", 20, 0, 200);
  TH1F *s_mttau = new TH1F("s_mttau", ";mTtau (GeV);area norm", 20, 0, 200);
  TH1F *s_mtall = new TH1F("s_mtall", ";mTall (GeV);area norm", 25, 0, 1000);
  TH1F *s_mltau = new TH1F("s_mltau", ";mltau (GeV);area norm", 30, 0, 300);
  TH1F *s_mt20 = new TH1F("s_mt20", ";mT20 (GeV);area norm", 20, 0, 200);
  ...
  TH1F *s1_mtlep = new TH1F("s1_mtlep", ";mTl (GeV);area norm", 20, 0, 200);
  TH1F *s1_mttau = new TH1F("s1_mttau", ";mTtau (GeV);area norm", 20, 0, 200);
  TH1F *s1_mtall = new TH1F("s1_mtall", ";mTall (GeV);area norm", 25, 0, 1000);
  TH1F *s1_mltau = new TH1F("s1_mltau", ";mltau (GeV);area norm", 30, 0, 300);
  TH1F *s1_mt20 = new TH1F("s1_mt20", ";mT20 (GeV);area norm", 20, 0, 200);
  ...
  TH1F *s2_mtlep = new TH1F("s2_mtlep", ";mTl (GeV);area norm", 20, 0, 200);
  TH1F *s2_mttau = new TH1F("s2_mttau", ";mTtau (GeV);area norm", 20, 0, 200);
  TH1F *s2_mtall = new TH1F("s2_mtall", ";mTall (GeV);area norm", 25, 0, 1000);
  TH1F *s2_mltau = new TH1F("s2_mltau", ";mltau (GeV);area norm", 30, 0, 300);
  TH1F *s2_mt20 = new TH1F("s2_mt20", ";mT20 (GeV);area norm", 20, 0, 200);
  ...
  */
  ...
  tb->Draw("MTLEP >> b_mtlep", standcuts); bhists.push_back(b_mtlep);
  tb->Draw("MTTAU >> b_mttau", standcuts); bhists.push_back(b_mttau);
  tb->Draw("MTALL >> b_mtall", standcuts); bhists.push_back(b_mtall);
  tb->Draw("MLTAU >> b_mltau", standcuts); bhists.push_back(b_mltau);
  tb->Draw("MT20 >> b_mt20", standcuts); bhists.push_back(b_mt20);
  ...
  ts->Draw("MTLEP >> s_mtlep", standcuts); shists.push_back(s_mtlep);
  ts->Draw("MTTAU >> s_mttau", standcuts); shists.push_back(s_mttau);
  ts->Draw("MTALL >> s_mtall", standcuts); shists.push_back(s_mtall);
  ts->Draw("MLTAU >> s_mltau", standcuts); shists.push_back(s_mltau);
  ts->Draw("MT20 >> s_mt20", standcuts); shists.push_back(s_mt20);
  ...
  ts1->Draw("MTLEP >> s1_mtlep", standcuts); shists1.push_back(s1_mtlep);
  ts1->Draw("MTTAU >> s1_mttau", standcuts); shists1.push_back(s1_mttau);
  ts1->Draw("MTALL >> s1_mtall", standcuts); shists1.push_back(s1_mtall);
  ts1->Draw("MLTAU >> s1_mltau", standcuts); shists1.push_back(s1_mltau);
  ts1->Draw("MT20 >> s1_mt20", standcuts); shists1.push_back(s1_mt20);
  ...
  ts2->Draw("MTLEP >> s2_mtlep", standcuts); shists2.push_back(s2_mtlep);
  ts2->Draw("MTTAU >> s2_mttau", standcuts); shists2.push_back(s2_mttau);
  ts2->Draw("MTALL >> s2_mtall", standcuts); shists2.push_back(s2_mtall);
  ts2->Draw("MLTAU >> s2_mltau", standcuts); shists2.push_back(s2_mltau);
  ts2->Draw("MT20 >> s2_mt20", standcuts); shists2.push_back(s2_mt20);
  ...
  */
  ...
  Double_t theBR = 1000*151.70789*b_met->GetEntries()/18020000;
  Double_t theS = 1000*180.70789*s_met->GetEntries()/1019242;
 //  Double_t theS = 1000*180.70789*s_met->GetEntries()/6300000;
  ...
  stringstream thes;
  thes << "13 TeV, ttbar (red), mstop = 500, 400, 300 GeV, m_{#tilde{#tau}}= 100 GeV : "  << standcuts << ends;
  
  for (int j = 0; j < shists.size(); j++){
    // bhists[j]->SetTitle("13 TeV, ttbar (red), mstop = 500, 400, 300 GeV, m_{#tilde{#tau}}= 100 GeV");
    bhists[j]->SetTitle(thes.str().c_str());
    bhists[j]->Draw();
    shists[j]->Draw("same");
    //    shists1[j]->Draw("same");
    //shists2[j]->Draw("same");
  if (j == 0){
      c3->SaveAs("match_higgsino_shapes.pdf(", "pdf");
