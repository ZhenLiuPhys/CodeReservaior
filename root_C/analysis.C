...
return (double)countsig*0.8*0.96/10000.*1.76*cs[i]/TMath::Sqrt((double)countbkg/100000.*1.76*csbkg);
}
...
ofstream myfile;
myfile.open ("significances.dat");

TFile *f2 = TFile::Open("BKG2b3.root");
