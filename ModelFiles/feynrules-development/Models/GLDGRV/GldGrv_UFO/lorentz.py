...
FFS12 = Lorentz(name = 'FFS12',
                spins = [ 2, 2, 1 ],
                structure = '-(P(-1,2)*P(-1,3)*Gamma(-2,-4,-3)*Gamma(-2,2,-4)*ProjM(-3,1)) + P(-2,3)*P(-1,2)*Gamma(-2,-4,-3)*Gamma(-1,2,-4)*ProjM(-3,1) - 2*P(-1,2)*P(-1,3)*ProjM(2,1)')
...
FFV17 = Lorentz(name = 'FFV17',
                spins = [ 2, 2, 3 ],
                structure = '-(Epsilon(3,-1,-2,-3)*P(-3,2)*P(-2,3)*Gamma(-1,2,-4)*ProjM(-4,1)) - complex(0,1)*P(-1,3)*P(3,2)*Gamma(-1,2,-2)*ProjM(-2,1) + complex(0,1)*P(-1,2)*P(-1,3)*Gamma(3,2,-2)*ProjM(-2,1) + Epsilon(3,-1,-2,-3)*P(-3,2)*P(-2,3)*Gamma(-1,2,-4)*ProjP(-4,1) - complex(0,1)*P(-1,3)*P(3,2)*Gamma(-1,2,-2)*ProjP(-2,1) + complex(0,1)*P(-1,2)*P(-1,3)*Gamma(3,2,-2)*ProjP(-2,1)')
...
FFVS11 = Lorentz(name = 'FFVS11',
                 spins = [ 2, 2, 3, 1 ],
                 structure = 'P(3,2)*Gamma(-1,-2,-3)*Gamma(-1,2,-2)*ProjM(-3,1) - P(-1,2)*Gamma(-1,-3,-2)*Gamma(3,2,-3)*ProjM(-2,1) - 2*P(3,2)*ProjM(2,1)')
...
FFVS24 = Lorentz(name = 'FFVS24',
                 spins = [ 2, 2, 3, 1 ],
                 structure = 'P(-1,1)*Gamma(-1,-2,-3)*Gamma(3,2,-2)*ProjP(-3,1) + P(3,1)*Gamma(-1,-3,-2)*Gamma(-1,2,-3)*ProjP(-2,1) - 4*P(3,1)*ProjP(2,1)')
...
FFVV3 = Lorentz(name = 'FFVV3',
                spins = [ 2, 2, 3, 3 ],
                structure = 'Epsilon(3,4,-1,-2)*P(-1,1)*Gamma(-2,2,-3)*ProjM(-3,1) + 2*complex(0,1)*P(4,1)*Gamma(3,2,-1)*ProjM(-1,1) - 2*complex(0,1)*P(3,1)*Gamma(4,2,-1)*ProjM(-1,1)')
...
FRVS4 = Lorentz(name = 'FRVS4',
                spins = [ 2, 4, 3, 1 ],
                structure = 'Gamma(2,2,-1)*Gamma(3,-1,-2)*ProjM(-2,1) - 2*Metric(2,3)*ProjM(2,1)')
