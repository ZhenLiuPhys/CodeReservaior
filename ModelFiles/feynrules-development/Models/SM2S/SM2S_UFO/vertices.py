...
V_1 = Vertex(name = 'V_1',
             particles = [ P.Sk, P.Sk, P.Sk, P.Sk ],
             color = [ '1' ],
             lorentz = [ L.SSSS1 ],
             couplings = {(0,0):C.GC_56})

V_2 = Vertex(name = 'V_2',
             particles = [ P.Ss, P.Ss, P.Ss, P.Ss ],
             color = [ '1' ],
             lorentz = [ L.SSSS1 ],
             couplings = {(0,0):C.GC_56})

V_3 = Vertex(name = 'V_3',
             particles = [ P.G0, P.G0, P.Sk, P.Sk ],
             color = [ '1' ],
             lorentz = [ L.SSSS1 ],
             couplings = {(0,0):C.GC_57})

V_4 = Vertex(name = 'V_4',
             particles = [ P.G__minus__, P.G__plus__, P.Sk, P.Sk ],
             color = [ '1' ],
             lorentz = [ L.SSSS1 ],
             couplings = {(0,0):C.GC_57})

V_5 = Vertex(name = 'V_5',
             particles = [ P.H, P.H, P.Sk, P.Sk ],
             color = [ '1' ],
             lorentz = [ L.SSSS1 ],
             couplings = {(0,0):C.GC_57})

V_6 = Vertex(name = 'V_6',
             particles = [ P.H, P.Sk, P.Sk ],
             color = [ '1' ],
             lorentz = [ L.SSS1 ],
             couplings = {(0,0):C.GC_96})

V_7 = Vertex(name = 'V_7',
             particles = [ P.G0, P.G0, P.Ss, P.Ss ],
             color = [ '1' ],
             lorentz = [ L.SSSS1 ],
             couplings = {(0,0):C.GC_58})

V_8 = Vertex(name = 'V_8',
             particles = [ P.G__minus__, P.G__plus__, P.Ss, P.Ss ],
             color = [ '1' ],
             lorentz = [ L.SSSS1 ],
             couplings = {(0,0):C.GC_58})

V_9 = Vertex(name = 'V_9',
             particles = [ P.H, P.H, P.Ss, P.Ss ],
             color = [ '1' ],
             lorentz = [ L.SSSS1 ],
             couplings = {(0,0):C.GC_58})
...
V_11 = Vertex(name = 'V_11',
              particles = [ P.G0, P.G0, P.Sk, P.Ss ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_59})

V_12 = Vertex(name = 'V_12',
              particles = [ P.G__minus__, P.G__plus__, P.Sk, P.Ss ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_59})

V_13 = Vertex(name = 'V_13',
              particles = [ P.H, P.H, P.Sk, P.Ss ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
              couplings = {(0,0):C.GC_59})

V_14 = Vertex(name = 'V_14',
              particles = [ P.H, P.Sk, P.Ss ],
              color = [ '1' ],
              lorentz = [ L.SSS1 ],
...
V_141 = Vertex(name = 'V_141',
               ...
               color = [ '1' ],
               lorentz = [ L.FFV2, L.FFV4 ],
               couplings = {(0,1):C.GC_85,(0,0):C.GC_76})
