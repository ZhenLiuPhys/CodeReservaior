...
GC_56 = Coupling(name = 'GC_56',
                 value = '(-3*complex(0,1)*lS)/4.',
                 order = {'QED':2})

GC_57 = Coupling(name = 'GC_57',
                 value = '-(complex(0,1)*omk)/4.',
                 order = {'QED':2})

GC_58 = Coupling(name = 'GC_58',
                 value = '-(complex(0,1)*oms)/4.',
                 order = {'QED':2})

GC_59 = Coupling(name = 'GC_59',
                 value = '-(complex(0,1)*omsk)/4.',
                 order = {'QED':2})
...
GC_96 = Coupling(name = 'GC_96',
                 value = '-(complex(0,1)*omk*vev)/4.',
                 order = {'QED':1})

GC_97 = Coupling(name = 'GC_97',
                 value = '-(complex(0,1)*oms*vev)/4.',
                 order = {'QED':1})

GC_98 = Coupling(name = 'GC_98',
                 value = '-(complex(0,1)*omsk*vev)/4.',
                 order = {'QED':1})
