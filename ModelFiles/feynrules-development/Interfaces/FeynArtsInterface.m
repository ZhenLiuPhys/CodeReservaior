...
newstruc = struc/.Eps->Epstemp/.{SP[a,b]->SP[mom[a],mom[b]],SlashedP[a_]->SlashedP[mom[a]],FV[a_,b_]->FV[mom[a],b],FV[a_]->FV[mom[a]]};
...
(*Print[vertexlistFA];*)
      ...
      tempxi = DeleteCases[Rulli[#,GaugeXi[#]]&/@ FA$ClassesList,Rulli[x_,GaugeXi[x_]]];
