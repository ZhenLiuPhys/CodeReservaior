...
FR$VersionNumber = "1.7.221";
FR$VersionDate = "18 September 2013";

Print[" - FeynRules - "];
Print["Version: ", FR$VersionNumber, " ("FR$VersionDate, ")."];
Print["Authors: A. Alloul, N. Christensen, C. Degrande, C. Duhr, B. Fuks"];
Print[" "];
Print["Please cite: Comput.Phys.Commun.180:1614-1641,2009 (arXiv:0806.4194)."];
...
QCDOnly::usage = "If True, the on-shell renormalization is only done for the field having QCD interactions. The default is False.";
...
OnShellRenormalization::usage = "return the renormalized Lagrangian in the on-shell scheme";
...
Block[{$Path = {$LocalFeynRulesPath, 
                ...
                StringJoin[$LocalFeynRulesPath, "/R2"]}
       },
